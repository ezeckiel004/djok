...
return [
    ...
    */
    ...
    'between' => [
        ...
        'string' => 'Le texte :attribute doit avoir une longueur comprise entre :min et :max caractères.',
    ],
    ...
    'mimes' => 'Le fichier :attribute doit avoir le type :values.',
    'mimetypes' => 'Le fichier :attribute doit avoir le type :values.',
    'min' => [
    ...
    'required_if' => 'Le champ :attribute est requis quand :other a la valeur :value.',
    'required_if_accepted' => 'Le champ :attribute est requis quand :other a été accepté.',
    ...
    */
    ...
    'custom' => [
        'prenom' => [
            ...
            'max' => 'Le prénom ne doit pas dépasser :max caractères.',
        ...
        'telephone' => [
            ...
            'string' => 'Le numéro de téléphone doit être une chaîne de caractères valide.',
        ],
        'access_code' => [
            'required' => 'Le code d\'accès est requis.',
            'max' => 'Le code d\'accès ne doit pas dépasser :max caractères.',
            'string' => 'Le code d\'accès doit être une chaîne de caractères valide.',
        ],
    ],
